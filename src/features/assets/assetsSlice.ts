...
export const discoverTokensAsync = createAsyncThunk(
  "assets/discover",
  async (request: DiscoverTokensRequest) => {
    const response = await discoverERC20Tokens(
      request.account,
...
export const loadBalancesAsync = createAsyncThunk(
  "assets/balance/load",
...
export const selectAssetsLoading = (state: RootState) =>
  state.assets.areAssetsDiscovering;
